...
func EqualsType(t testing.TB, expect, got any) {
	t.Helper()
	equal(
...
// compare using JSON
func NotEqualsJSON(t testing.TB, expect, got any) {
	t.Helper()
